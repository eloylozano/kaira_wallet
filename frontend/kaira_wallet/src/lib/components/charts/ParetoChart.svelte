...
<div class="kaira-panel rounded-[32px] p-6">
    <div class="mb-6 flex items-center justify-between px-2">
        <div class="flex flex-col gap-1">
            <span class="text-[10px] font-black uppercase tracking-[0.2em] text-white/30">Análisis Pareto</span>
        </div>
        <div class="flex gap-5">
            <div class="flex items-center gap-2">
                <div class="h-1.5 w-1.5 rounded-full bg-rose-500 shadow-[0_0_8px_rgba(244,63,94,0.4)]"></div>
                <span class="text-[10px] font-bold text-white/40 uppercase tracking-wider">Gasto</span>
            </div>
            <div class="flex items-center gap-2">
                <div class="h-1.5 w-1.5 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.4)]"></div>
                <span class="text-[10px] font-bold text-white/40 uppercase tracking-wider">Acum.</span>
            </div>
        </div>
    </div>
    ...
    {#if paretoData.length === 0}
        <div class="flex h-72 flex-col items-center justify-center">
            <div class="mb-3 h-10 w-10 animate-pulse rounded-full border-2 border-dashed border-white/10"></div>
            <p class="text-[10px] font-black uppercase tracking-[0.2em] text-white/20">Sin datos para este periodo</p>
        </div>
    {/if}
</div>

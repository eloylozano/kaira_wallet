<script lang="ts">
	...
	async function validate() {
		...
		if (isValid) {
			haptics.success();
			auth.unlock();
			// Recargar la ventana para re-inicializar todos los stores con los nuevos cabezales 'X-Kaira-PIN'
		...
		<div class="relative mb-10 flex flex-col items-center">
			...
			>
				<svg
					...
					stroke="currentColor"
					stroke-width="1.5"
					class="text-emerald-400 drop-shadow-[0_0_8px_rgba(16,185,129,0.5)]"
				>

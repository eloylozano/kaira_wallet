<script lang="ts">
	...
	const netWorth = $derived(
		statsService.summaryData.total_income - statsService.summaryData.total_expense
	);
...
<div class="flex flex-col gap-6 py-6">
	<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
		<div
			class="kaira-panel flex flex-col justify-center rounded-3xl p-5 sm:col-span-2 md:col-span-1"
		>
			<span class="text-[10px] font-black tracking-widest uppercase opacity-30"
				>Patrimonio Neto</span
			>
		...
		<div
			class="kaira-panel flex flex-col justify-center rounded-3xl border-l-4 border-sky-500/50 p-5"
		>
			<span class="text-[10px] font-black tracking-widest uppercase opacity-30"
		...
		<div
			class="kaira-panel flex flex-col justify-center rounded-3xl border-l-4 border-emerald-500/50 p-5"
		>
			<span class="text-[10px] font-black tracking-widest text-balance uppercase opacity-30"
				>Efectivo (2% TAE)</span
			>
	...
	<div class="kaira-panel rounded-[32px] p-6">
		<div class="mb-6">
			<h2 class="text-[10px] font-black tracking-[0.2em] uppercase opacity-40">

...
<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-6 backdrop-blur-md">
	<form
		class="absolute top-0 left-0 h-1 w-1 overflow-hidden opacity-0"
	...
	<div
		class="glass-panel light:bg-white/95 relative flex w-full max-w-sm flex-col items-center overflow-hidden rounded-[40px] border border-white/10 bg-[#020617]/90 p-10 shadow-2xl
        transition-colors duration-500 dark:bg-[#020617]/90"
	>
		<div
		...
		<h2 class="pin-text mb-8 text-lg font-bold tracking-tight">Seguridad Kaira</h2>
		...
		<div class="grid grid-cols-3 gap-6">
			{#each ['1', '2', '3', '4', '5', '6', '7', '8', '9', '', '0', 'DEL'] as key}
				<button
					...
					class="pin-text h-16 w-16 text-xl font-medium transition-all active:scale-95
                    {key === ''
						? 'pointer-events-none opacity-0'
						: 'glass-btn-pin flex items-center justify-center rounded-full'}"
				>
					{#if key === 'DEL'}
						<svg
							xmlns="http://www.w3.org/2000/svg"

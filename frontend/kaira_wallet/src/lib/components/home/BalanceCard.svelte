...
<div class="sticky top-0 z-40 w-full transition-all duration-500 {scrolled ? 'pt-2' : 'pt-4'}">
	<div class="mx-auto max-w-xl">
		<div
			class="glass-panel relative overflow-hidden border border-white/10 px-6 transition-all duration-500"
			...
			<div class="relative z-10 flex flex-col">
				<div class="flex items-center justify-between">
					<div class="flex flex-col">
						<p
							class="text-[10px] font-black tracking-[0.2em] text-primary/70 uppercase"
					...
					<div class="flex items-center gap-3">
						{#if scrolled}
							<div class="flex gap-3 border-r border-white/10 pr-4 text-[11px] font-bold">
